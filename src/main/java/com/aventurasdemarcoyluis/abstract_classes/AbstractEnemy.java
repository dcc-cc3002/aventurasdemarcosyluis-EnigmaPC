...
public abstract class AbstractEnemy extends AbstractEntities implements IEnemy {
     ...
     */
    public AbstractEnemy(int level, int attack, int defense, int maxHealPoints, int maxFightPoints, String name) {
        super(level, attack, defense, maxHealPoints, maxFightPoints, name);
    }

    /**
     * Entrega el daño que un jugador podría hacerle a un enemigo (this) con
     ...
     * @return Daño que un jugador podría hacer a un enemigo con cierto ataque.
     */
